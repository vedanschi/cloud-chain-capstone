...
const UIController = {
    ...
    executeTransfer(decisionType, targetNode, quantity, netImpact) {
        ...
        consoleDiv.innerHTML = `<div style="color: var(--neon-green);">>> SUCCESS: ${quantity} units of ${this.selectedAsset.sku} transferred ${originNode} &rarr; ${destNode}.</div>` + consoleDiv.innerHTML;

        // FIXED: Call the ledger directly without the broken 'window' check
        try {
